    ...
    <tbody>
       ...
       %>
        <tr>
            ...
            <td><a href="Approved/<%=orders.getCustNo() %>"><button class="btn1" type="submit">Approved</button></a></td>
            <td><a href="Disapproved/<%=orders.getCustNo() %>"><button class="btn1" type="submit">Disapproved</button></a></button></td>
